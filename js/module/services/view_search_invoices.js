...
(function (window) {
    ...
    view_search_invoices.prototype.get_document_arrival = function (document) {
        ...
        return {
            ...
            nameStnTo: document.codeStnToNavigation ? document.codeStnToNavigation['stationName' + ucFirst(App.Lang)] : null,
            arrivalCargoName: vagons.length > 0 ? vagons[0].arrivalCargoName : null,
            vesg: summ_vesg,
            ...
            arrivalOperatorAbbr: vagons.length > 0 ? vagons[0].arrivalOperatorAbbr : null,
            toDivisionAbbr: vagons.length > 0 ? vagons[0].toDivisionAbbr : null,
            ...
            dateOtpr: document.dateOtpr,
            dateAdoption: vagons.length > 0 ? vagons[0].dateAdoption : null,
