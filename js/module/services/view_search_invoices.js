...
(function (window) {
    ...
    $.Text_View =
    {
        'default':  //default language: ru
        {
            ...
            //'vs_shinv_card_header_cost_calculation': 'РАСЧЕТ СТОИМОСТИ',
    ...
    view_search_invoices.prototype.init = function (options) {
        ...
        this.$main.append(this.card_services.$html.append(this.search_invoices_arrival.$html));
    ...
    // получить документ
    view_search_invoices.prototype.get_document = function (document) {
        ...
        this.ids_arrival.getVerificationArrivalUzDocumentOfNum(num_epd, function (document) {
            ...
            if (document !== null && document.length > 0) {
                ...
                $.each(document, function (i, el_doc) {
                    this.document_arrival.push(this.get_document(el_doc));
                }.bind(this));
