...
(function (window) {
    ...
    $.Text_View =
    {
        ...
        {
            'vodlc_card_header_panel': 'ВЫПОЛНИТЬ ОПЕРАЦИЮ "ДИСЛОКАЦИЯ ВАГОНОВ НА СТАНЦИИ АМКР"',
            ...
            'vodlc_title_form_apply_title': 'Выполнить операцию "ДИСЛОКАЦИЯ ВАГОНОВ НА СТАНЦИИ АМКР"',
