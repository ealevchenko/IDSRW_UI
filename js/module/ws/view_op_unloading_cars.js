...
/*                                            (rows ? rows.length : 0),*/
        ...
        var get_sostav_filing = function (row, station, way, park, division, wagons) {
            return {
                ...
                countUnloadingWagons: row ? (row.filingEnd !== null && (row.filingIdLoadingStatus === App.wsd_setup.loading_status.empty || row.filingIdLoadingStatus === App.wsd_setup.loading_status.dirty) ? 1 : 0) : 0,
