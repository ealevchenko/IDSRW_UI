...
(function (window) {
    ...
    print_arr.prototype.view_natural_statement_draft = function (format, id) {
        ...
        var natural_statement_title = function ($body, sostav) {
            ...
            $tr1.append('<td scope="col">' + OutText((sostav.numeration === true ? langView('prn_arr_title_from_tail', App.Langs) : sostav.numeration === false ? langView('prn_arr_title_from_head', App.Langs) : langView('prn_arr_title_not_specified', App.Langs))) + '</td>');
